 ...
 */
final class Version20241208231054 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE company (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(150) NOT NULL, street VARCHAR(255) DEFAULT NULL, zip VARCHAR(100) DEFAULT NULL, city VARCHAR(200) DEFAULT NULL, email VARCHAR(200) DEFAULT NULL, phone VARCHAR(200) DEFAULT NULL, updated_at DATETIME NOT NULL, created_at DATETIME NOT NULL, UNIQUE INDEX UNIQ_4FBF094F5E237E06 (name), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE `utf8_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE `helpdesk_user` ADD CONSTRAINT FK_7751CFD9979B1AD6 FOREIGN KEY (company_id) REFERENCES company (id)');
