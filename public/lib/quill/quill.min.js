...
// add comment in issue view
if($('#comment').length) {
   initQuillEidtor('comment', 'commentSaveBtn');
}

// add / edit inernal note on issue
// add new Tiket
if($('#quillEditor').length) {
    initQuillEidtor('quillEditor', 'quillEditorSaveBtn');
}

function initQuillEidtor(selector, onSaveSelector) {
    let editor = $('#' + selector);
    editor.attr('spellcheck', false);
    editor.attr('autocomplete', false);
    editor.attr('dragable', false);
    var toolbarOptions = [
    ...
    let btnSave = document.getElementById(onSaveSelector);
