...
#[Route('/dashboard/ticket/external-note/7697y1z3i0t2o8am')]
class ExternalNoteController extends AbstractDashboardController
{
    ...
    #[Route('/add/{id}', name: 'app_dashboard_ticket_store_external_note', methods: 'POST')]
    public function store(?string $id, Request $request): RedirectResponse
    {
        ...
        $this->ticketService->save($issue->setExternalNote($note));

        $this->addFlash('success', 'Note has been saved.');
    ...
    #[Route('/delete/{id}', name: 'app_dashboard_ticket_store_external_note_clear', methods: 'POST')]
    public function delete(?string $id, Request $request): RedirectResponse
    {
        ...
        $this->ticketService->save($issue->setExternalNote(null));
